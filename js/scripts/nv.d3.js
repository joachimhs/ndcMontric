...
nv.charts = {}; //stores all the ready to use charts.hbs
...
nv.models.axis = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      //TODO: consider calculating width/height based on whether or not label is added, for reference in charts.hbs using this component
...
nv.models.scatterChart = function() {
  ...
  var showTooltip = function(e, offsetElement) {
    //TODO: make tooltip style an option between single or dual on axes (maybe on all charts.hbs with axes?)
